...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='../last_ckpt.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='../TestASet/data_stage4', help='the source path, e.g. image-file/dir.')
    # parser.add_argument('--source', type=str, default='../dataset/data_stage5/images/val', help='the source path, e.g. image-file/dir.')
    parser.add_argument('--yaml', type=str, default='../dataset.yaml', help='data yaml file.')
    parser.add_argument('--img-size', type=int, default=704, help='the image-size(h,w) in inference size.')
    parser.add_argument('--conf-thres', type=float, default=0.10, help='confidence threshold for inference.')
    parser.add_argument('--iou-thres', type=float, default=0.05, help='NMS IoU threshold for inference.')
    parser.add_argument('--max-det', type=int, default=10, help='maximal inferences per image.')
    parser.add_argument('--device', default='0', help='device to run our model i.e. 0 or 0,1,2,3 or cpu.')
    parser.add_argument('--save-txt', default='./runs/inference/exp', action='store_true', help='save results to *.txt.')
    parser.add_argument('--save-img', default=True, action='store_true', help='save visuallized inference results.')
