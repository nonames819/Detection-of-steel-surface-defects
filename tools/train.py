...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='../dataset.yaml', type=str, help='path of dataset')
    parser.add_argument('--conf-file', default='../configs/yolov6_tiny.py', type=str, help='experiments description file')
    parser.add_argument('--img-size', default=704, type=int, help='train, val image size (pixels)')
    ...
    parser.add_argument('--check-labels', default=False, action='store_true', help='check label files when initializing datasets')
